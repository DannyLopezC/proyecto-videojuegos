		...
		override public void OnInspectorGUI()
		{
			...
			if (UsesShadows())
			{
				...
				if (script.mainShape.shadowType != DayLightCollider2D.ShadowType.None)
				{
					...
					if (script.mainShape.shadowType == DayLightCollider2D.ShadowType.SpritePhysicsShape || script.mainShape.shadowType == DayLightCollider2D.ShadowType.Collider2D)
					{
						...
						else if (script.mainShape.shadowType != DayLightCollider2D.ShadowType.FillCollider2D && script.mainShape.shadowType != DayLightCollider2D.ShadowType.FillSpritePhysicsShape)
					{
						EditorGUILayout.PropertyField(shadowDistance, new GUIContent ("Shadow Distance"));
					}
